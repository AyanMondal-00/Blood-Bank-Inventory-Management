...
export const inventoryApi = {
  ...
  getRevisedCharges: () => apiRequest('/inventory/revised-charges'),
  updateRevisedCharge: (payload) => apiRequest('/inventory/revised-charge', { method: 'PUT', body: JSON.stringify(payload) }),
}
